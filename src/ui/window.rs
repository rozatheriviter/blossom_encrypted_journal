...
fn build_bottom_bar() -> BottomBarWidgets {
    ...
    // Noise section
    let noise_box = gtk4::Box::new(gtk4::Orientation::Horizontal, 8);
    noise_box.set_valign(gtk4::Align::Center);
    let bs = noise_slider_vertical("noise-slider-brown");
    let ps = noise_slider_vertical("noise-slider-pink");
    let ws = noise_slider_vertical("noise-slider-white");
    let ms = noise_slider_vertical("noise-slider-master");
...
fn noise_slider_vertical(class: &str) -> gtk4::Scale {
