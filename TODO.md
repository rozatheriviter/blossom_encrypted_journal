...
- [ ] Passphrase change — change a vault's passphrase without deleting it
...
- [ ] Pinned entries — star/pin an entry to keep it at the top of the list
- [ ] bottom bar should go vertical when resizing width too narrow so that window can be snapped. important on 720p screen. ✓
- [ ] attached media should be able to be viewed in app, or at least enlarged.
- [ ] program should not remember last file path added. this is a vulnerability ✓
